...
// 1. Add a .click() handler to elements with the class of .row - OK
// 2. Associate this .click() handler with an anoymous function (in other words, "pass" .click() and anonymous function) - OK TO SKIP
